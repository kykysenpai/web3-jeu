var ReplaySelector = {
	preload: function() {
        ...
        switch(chosenGameMode){
            ...
            case 5:
                console.log("pass")
                game.load.json('replay', 'assets/replays/SnakeDefault/replays.json');
                game.load.image('levelThumb', 'assets/defaultSnake.png');
                break;
            case 6:
                game.load.json('replay', 'assets/replays/SnakeSmall/replays.json');
                game.load.image('levelThumb', 'assets/randomSSnake.png');
                break;
            case 7:
                game.load.json('replay', 'assets/replays/SnakeMedium/replays.json');
                game.load.image('levelThumb', 'assets/randomMSnake.png');
                break;
            case 8:
                game.load.json('replay', 'assets/replays/Large/replays.json');            
                game.load.image('levelThumb', 'assets/randomLSnake.png');
                break;
        }
	},
	create: function() {
