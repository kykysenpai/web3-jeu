	...
	for (var i = 1; i < height - 1; i++) {
		for (var j = 1; j < width - 1; j++) {
			...
			if ((this.size == 'Default' && tile === 7) ||
				...
				this.mapDots[[j * 16, i * 16]].isAlive = false;
			}
		}
	}
};
